...
extern int uart4_putchar(uint8_t c);
extern int uart4_getchar(void);
extern int uart4_write(const uint8_t *data, int size);
extern int uart4_read(uint8_t *data, int size);
extern int uart4_printf(const char *format, ...);
